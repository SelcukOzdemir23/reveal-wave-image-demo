...
export default function LiquidGradient({ 
  ...
  return (
    <div 
      className="relative w-full h-[85vh] overflow-hidden rounded-3xl border border-white/5 shadow-2xl"
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-6 text-center pointer-events-none">
          ...
          <button 
            className="pointer-events-auto px-10 py-4 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-full hover:scale-105 transition-all shadow-xl active:scale-95"
            onClick={onCtaClick}
          >
            {ctaText}
          </button>
      ...
      {showPauseButton && (
        <button
          ...
          className="absolute bottom-8 right-8 pointer-events-auto w-10 h-10 flex items-center justify-center rounded-full bg-black/20 backdrop-blur-md border border-white/10 text-white/60 hover:text-white transition-all z-20"
