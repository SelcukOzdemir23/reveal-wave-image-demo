...
// Fix: Define component aliases for Three.js intrinsic elements to resolve JSX type errors
...
function ImagePlane({
  ...
  return (
    // Fix: Using uppercase component aliases for Three.js elements to resolve JSX type errors
